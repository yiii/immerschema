# Migration Guide: Immerschema 1.2.0

This guide will help you migrate your existing Immerschema projects to version 1.2.0, which introduces significant improvements in schema organization, validation, and testing.
...
npm install immerschema@1.2.0 --save
```

...
A modular JSON-Schema suite for fulldome / CG pipelines – now with **property-wrapped array slices** and **advanced task lifecycle management**.
...
{
  "$id": "immerschema/slices/tasks.prop.slice.json",
  "type": "object",
  "properties": {
          ...
          "items": {
            "properties": {
              "shotId": {
                "type": "array",
                "items": { "type": "string" },
                "description": "Optional links back to shot IDs"
              }
            }
          }
        }
